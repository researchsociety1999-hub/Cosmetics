...
type SearchParams = Promise<{ status?: string; email?: string }>;
      ...
      <main className="mx-auto max-w-xl px-4 py-14 md:px-6">
        ...
        <div className="mystic-card mt-8 space-y-5 p-6">
          <p className="text-sm leading-relaxed text-[#b8ab95]">
            Use a secure magic link to sign in with Supabase auth. Once your session
            is active, checkout will load your authenticated cart from `cart_items`.
          </p>
